...
/**
 * The 1.8 potion-duration lookup that {@code PotionDurationModule} restores.
 *
...
public final class PotionDurations {
     ...
     */
    private record Family(Variant base, Variant strong, Variant extended) {
    ...
    public static int eraDurationTicks(
            String potionTypeKey, boolean extended, boolean upgraded, boolean splash) {
