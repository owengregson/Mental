...
public final class PositionHistory {
    ...
    public void record(@NotNull UUID player, double x, double y, double z, long nowNanos) {
     ...
     * predates the ring.
     */
    public @NotNull List<Sample> samplesAround(@NotNull UUID player, long instantNanos, long windowNanos) {
