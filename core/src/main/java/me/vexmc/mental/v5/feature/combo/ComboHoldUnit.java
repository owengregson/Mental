 ...
 *
 * <p>The reach handicap is its OWN module ({@code ComboReachHandicapUnit}) since
 * 2.4.4 — it depends on this one (it rides the combo transitions) but owns its own
 * lifecycle, so this unit no longer touches it.</p>
 */
